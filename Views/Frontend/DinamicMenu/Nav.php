    ...
    <ul class="nav">
        ...
        function render_menu($menus)
        {
            foreach ($menus as $menu_item) {
                ...
                // Renderizar submenús recursivamente submenus dentro de submenus
        ...
        if (!empty($menx)) {
            ...
            echo "No hay menus para mostrar.";
        }
        ?>
    </ul>
</div>
...
<div class="adicion">
    <div class="menu_edit">
        <a href="../../../Services/Persistence/Menu/MenuList.php">
            <i class="ri-file-edit-fill" style="font-size: 30px;"></i>
        </a>Editar menu</p>
    </div>

    <div class="menu_edit">
        <a href="../../../Services/Persistence/Persons/ListPersons.php">
            <i class="ri-user-line" style="font-size: 30px;"></i>
        </a>
        </a>Lista Personas </p>
    </div>

    <div class="menu_edit">
        <a href="../../../Services/Persistence\Departamentos\DepartamentosList.php">
        <i class="ri-building-line" style="font-size: 30px;"></i>
    </a>Lista de Departamentos</p>
